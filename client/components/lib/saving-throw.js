      ...
      ["$urlRouterProvider",
        ...
        function($urlRouterProvider, $stateProvider, $locationProvider) {
          ...
          //homepage
            ...
            .state('home', {
              url: '/',
              templateUrl: baseUrl + 'homepage/home/index.ng.html',
              controller: 'indexCtrl'
            })
            .state('privacy', {
              url: '/privacy',
              templateUrl: baseUrl + 'homepage/privacy/index.ng.html',
            })
            .state('terms', {
              url: '/terms',
              templateUrl: baseUrl + 'homepage/terms/index.ng.html',
            })

          //login
          .state('login', {
              url: '/login',
              templateUrl: baseUrl + 'accounts/login/index.ng.html',
              controller: 'loginCtrl',
            })
            .state('register', {
              url: '/register',
              templateUrl: baseUrl + 'accounts/register/index.ng.html',
              controller: 'registerCtrl',
            })
            .state('recover', {
              url: '/recover',
              templateUrl: baseUrl + 'accounts/recover/index.ng.html',
              controller: 'recoverCtrl',
            })
            .state('reset', {
              url: '/reset/:token',
              templateUrl: baseUrl + 'accounts/reset/index.ng.html',
